...
//    NSTimeInterval createTime = [createTimeString longLongValue] / 1000;
    NSTimeInterval createTime = [createTimeString timeIntervalSince1970];
    // 计算时间差
...
//        NSTimeInterval interval = createTime/1000.0;
        NSTimeInterval interval = createTime;
    ...
    //秒转月
    //    long long months = time/3600/24/30;
    //    if (months < 12) {
...
//    NSTimeInterval interval=[timeString longLongValue] / 1000.0;
    ...
    return times;
    //    }
    //    long long year = time/3600/24/30/12;
    //
    //    NSString* times = [NSString stringWithFormat:@"%lld年前",year];
    //
    //    return times;
}
@end
